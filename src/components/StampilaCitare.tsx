...
export default function StampilaCitare({ intrebare, raspuns, sursa }: Props) {
  return (
    <figure className="mt-10 max-w-[640px] border border-linie-noapte bg-noapte/70 p-6 backdrop-blur-[6px] md:p-8">
      <figcaption className="mb-5 flex items-center justify-between font-mono text-[11px] tracking-[0.2em] uppercase text-hartie-veche-3">
      ...
      <p className="mt-5 inline-flex flex-wrap items-center gap-x-3 border-l-2 border-arama-clar bg-noapte-3 px-3 py-2 font-mono text-[12.5px] tracking-[0.06em] text-arama-clar">
